...
class BaseDataset(metaclass=ABCMeta):
    ...
    def save_processed_data(self,
        ...
        """process data, and save processed data.
        ...
        subjects : List[Union[int, str]]
            subjects whose data should be returned
        path : Optional [Union[str, Path]], optional
            Enter the location where the processed data is stored.
            If not, use environment variable or set parameter
        force_update : bool, optional
            force update of the dataset even if a local copy exists, by default False
        update_path : Optional[Union[str, Path]], optional Path to save processed data.
        Default is None.
        proxies: Optional[Union[bool, str, int]], optional
            proxies if needed
        verbose : Optional[Union[bool, str, int]], optional
            [description], by default None
        select_ch: List[str], The number of channels to be used for the model. Default is None.
        """
        pass
